curl --location --request POST 'http://k8s.arcadia-finance.io:30274/user/register?element_parents=account/mail/%23value&ajax_form=1&_wrapper_format=drupal_ajax' \
